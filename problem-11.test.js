const { Matrix, largestProduct } = require("./problem-11");
...
describe("Tests for problem 11: Largest product in a grid", () => {
  ...
  test("returns largest product of four adjacent numbers in every direction", () => {
    const DATA =
    ...
    m.fill(DATA);
    expect(largestProduct(m)).toBe(70600674);
  });
});
